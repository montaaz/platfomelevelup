...
function emailHtml(title: string, body: string | null): string {
  ...
  <div style="max-width:520px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden">
    <div style="background:#000024;padding:20px 28px">
      <span style="color:#ffffff;font-size:18px;font-weight:bold;letter-spacing:1px">LEVEL UP <span style="color:#6c24fc">IA</span></span>
    </div>
    <div style="padding:28px">
      <h1 style="margin:0 0 8px;font-size:17px;color:#000024">${title}</h1>
      ${body ? `<p style="margin:0 0 20px;font-size:14px;line-height:1.6;color:#475569">${body}</p>` : ""}
      <a href="${APP_URL}" style="display:inline-block;background:#1860fc;color:#ffffff;text-decoration:none;font-size:14px;font-weight:bold;padding:11px 22px;border-radius:10px">Ouvrir mon espace</a>
    </div>
