...
export function OnboardingWizard({
  ...
  /** Étape valide ? (le bouton Continuer reste désactivé sinon) */
    ...
    <div className={`${styles.card} ${styles.wizard}`}>
      ...
      {step === 0 && (
        <>
          ...
          <div className={`${styles.phoneRow} ${styles.field}`}>
            <select
      ...
      {step === 6 && (
        <>
          ...
          <p className={styles.hint}>Facultatif — vous pouvez passer cette question.</p>
