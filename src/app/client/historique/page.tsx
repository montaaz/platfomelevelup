            ...
            <tbody>
              {history.map((h) => (
                <tr key={h.id} className="border-b border-ink/4 last:border-0 hover:bg-white/40">
                  <td className="px-6 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="truncate text-[12px] text-slate-400">{h.serviceName}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3.5 text-[13px] text-slate-500">{formatDateFull(h.startDate ?? h.createdAt)}</td>
                  <td className="px-4 py-3.5 text-[13px] text-slate-500">{formatDateFull(h.deliveredAt)}</td>
