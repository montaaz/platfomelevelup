      ...
      {mode === "revision" ? (
        <div className="mt-3 space-y-2.5">
          <textarea
            ...
            className="w-full rounded-xl border border-white/70 bg-white/55 backdrop-blur-md px-3.5 py-2.5 text-[13px] outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100"
          />
