  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full rounded-xl border border-ink/10 px-4 py-3 text-[14px] outline-none focus:border-brand-400 focus:ring-2 focus:ring-brand-100 disabled:bg-slate-50 disabled:text-slate-400"
      />
    </div>
  );
}
...
export function ProfileForm({ profile }: { profile: Profile }) {
  ...
  return (
    <form onSubmit={onSubmit} className="max-w-2xl space-y-6">
      <section className="space-y-4 rounded-2xl border border-ink/5 bg-white p-6 shadow-card sm:p-7">
